            ...
            <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.12)] border border-slate-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-4">
              ...
              <div className="max-h-80 overflow-y-auto">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    className="p-4 border-b border-slate-100 hover:bg-slate-50 transition-colors flex gap-4 cursor-pointer group"
                  >
                    <div
                      className={cn(
                    ...
                    <div className="flex-1">
                      ...
                      {notif.type === 'request' && (
                        <div className="flex gap-2 mt-3">
                          <button className="px-3 py-1.5 bg-primary text-white rounded-lg text-xs font-bold cursor-pointer">
                            Duyệt
                          </button>
                          <button className="px-3 py-1.5 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold cursor-pointer">
                            Từ chối
                          </button>
                        </div>
                      )}
              ...
              <div className="p-3 text-center border-t border-slate-100 bg-slate-50/50">
                <button className="text-xs font-bold text-primary hover:opacity-80">
